            ...
            <div class="panel-body">
                ...
                <div role="tabpanel">
                  ...
                  <ul class="nav nav-tabs tabcolor6-bg" role="tablist">
                    <li role="presentation" class="active"><a href="#dataPO" aria-controls="dataPO" role="tab" data-toggle="tab">:::Data Utama:::</a></li>
                    <li role="presentation"><a href="#databarang" aria-controls="databarang" role="tab" data-toggle="tab">:::Data Barang Detail:::</a></li>
                  </ul>

                  <!-- Tab panes -->
                  <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="dataPO">

                            ...
                            <tbody>
                                ...
                                foreach ($supplier as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td>  <a href="<?php echo base_url() ?>index.php/masterdata/mastersupplier/delete/<?php echo $row['idsupplier'] ?>" class="btn btn-danger" onclick="return confirm('Anda Yakin Ingin Menghapus Data Suplier ini?')"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                    <?php $idsupplier++;
                                }
                                ?>        

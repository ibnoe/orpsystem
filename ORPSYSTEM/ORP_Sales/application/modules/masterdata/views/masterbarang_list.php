...
<div class="content" style="min-height:650px">
    ...
    <div class="page-header">
        ...
        <a data-toggle="modal" data-target="#myModalAdd" class="btn btn-info btn-xl" onclick="tambah();"><i class="fa fa-plus"></i>Tambah Data Barang</a>
            </div>
        </div>
                        ...
                        <table id="data_table" class="table display">
                            <thead>
                                <tr>
                                    ...
                                    <th>Jenis Barang</th>
                                    <th>Nama Barang</th>
                                    <th>Harga Jual Minimal</th>
                                    <th>Harga Jual Maximal</th>
                                    <th>Satuan</th>
                                    <th>Detail</th>
                                    <th>Hapus</th>
                                </tr>
                            ...
                            <tbody>
                                ...
                                foreach ($refbarang as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['harga_min'] ?></td>
                                        <td><?php echo $row['harga_max'] ?></td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="harga_min" class="col-sm-2 control-label form-label">Harga Jual Minimal</label>
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="harga_min" id="harga_min">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="harga_max" class="col-sm-2 control-label form-label">Harga Jual Maximal</label>
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="harga_max" id="harga_max">
                                </div>
                            </div>
...
<script>
    ...
    function tambah() {
        ...
        $('#idrefgudang').val('');
        $('#image_file').val('');
         $('#div_image_file').html('<img src="" width="150">');
        ...
        $.ajax({
            ...
            success: function (data)
            {
                ...
                if (data.response == 'success') {
                    ...
                    $('#harga_min').val(data.datas.harga_min);
                    $('#harga_max').val(data.datas.harga_max);

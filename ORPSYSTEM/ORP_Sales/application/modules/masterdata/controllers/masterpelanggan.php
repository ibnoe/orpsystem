...
class MasterPelanggan extends MX_Controller {
    ...
    public function index() {
        ...
        $data = array();
        $data['link'] = base_url('index.php')."/" . "masterdata/masterpelanggan/list_data";
    ...
    public function proses() {
        ...
        redirect('masterdata/masterpelanggan');
        } else {
           ...
           // echo json_encode($result);
             Message::_set(TRUE, 'Hapus Data Pelanggan Berhasil', 'Hapus Data Pelanggan Gagal');
        redirect('masterdata/masterpelanggan');
        }
    }
    ...
    public function delete($idpelanggan = null) {
        ...
        if ($idpelanggan != null) {
           ...
           // echo json_encode($result);
            Message::_set(TRUE, 'Hapus Data Pelanggan Berhasil', 'Hapus Data Master Pelanggan Gagal');
        redirect('masterdata/masterpelanggan');

        ...
        <div class="login-form">
            ...
            <form action="<?php echo base_url() ?>index.php/register/proses/" method="POST">
                ...
                <div class="form-area">
                    ...
                    <div class="group">
                        <input type="text" name="namalengkap" class="form-control" placeholder="Full Name" required>
                        <i class="fa fa-user"></i>
                    </div>
                    
                    <div class="group">
                        <input type="text" name="nama_refstore" class="form-control" placeholder="Retail Name" required>
                        <i class="fa fa-user"></i>
                    </div>
                    <div class="group">

...
$db['default']['password'] = 'rahasia123';
$db['default']['database'] = 'ORPSYSTEM';
...
$db['server']['hostname'] = '128.199.116.19';
$db['server']['username'] = 'bizon';
$db['server']['password'] = '123456';
$db['server']['database'] = 'ORPSYSTEM';

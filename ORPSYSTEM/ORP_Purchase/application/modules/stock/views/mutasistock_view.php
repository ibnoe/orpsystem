...
<div class="content" style="min-height:650px">
    ...
    <div class="page-header">
        <h1 class="title">Mutasi Stock</h1>
        <ol class="breadcrumb">
...
<link type="text/css" href="<?php echo base_url() ?>front_assets/library/gb/greybox.css" rel="stylesheet" />
            ...
            <script>
                ...
                function cetakPDF() {
                    ...
                    GB_show("Cetak Daftar Barang Masuk", '<?php echo base_url() ?>index.php/stock/mutasistock/cetakPDF/'+tanggal_dari+'/'+tanggal_sampai+'/'+idrefbarang, 500, 1080);
                    $('html, body').animate({
                        scrollTop: 0}, 'slow');
                }
            </script>

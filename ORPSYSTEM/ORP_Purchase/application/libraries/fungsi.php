...
function Md5AddSecret($data)
	{
		$pengacak = "ADIB-ADZY-LA86";
		$strPassword= md5($pengacak . md5($data) . $pengacak);
		return $strPassword;
	}	
...
function array_delete(&$ary,$key_to_be_deleted)
	...
	function load_ajax($url,$div)
	{
	    $data['url'] = $url;
	    $data['div'] = $div;
	    $this->CI->load->view('home/load_page',$data);
	}
	function notice($msg)
	{
	    $data['msg'] = $msg;
	    $this->CI->load->view('utama/notice_msg',$data);
	}

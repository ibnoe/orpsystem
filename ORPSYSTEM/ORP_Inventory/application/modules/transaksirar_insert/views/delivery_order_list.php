    ...
    <div class="page-header">
        ...
        <div class="right">
            <div class="btn-group" role="group" aria-label="...">
				<a href="#" data-toggle="modal" data-target="#myModalAdd" class="btn btn-info btn-xl" id="addData"><i class="fa fa-plus"></i>Tambah Baru</a>
            </div>
        </div>
                            ...
                            <tbody>
                                ...
                                foreach ($deliveryorder as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
											<a data-toggle="modal" data-target="#myModalEdit" class="btn btn-option5" onclick="details('<?php echo  $row['iddeliveryorder']; ?>')"><i class="fa fa-edit">Detail</i></a>
...
<script>
	...
	function deleted(id){
		...
		if (confirm("Yakin akan dihapus?") == true) {
			uri = '<?php echo site_url('/') . 'transaksirar_insert/deliveryorder/delete'?>';
			$.ajax({
					url : uri,
					type: "POST",
					data : {id:id},
	...
	$("#addData").click(function(){
		...
		uri = '<?php echo site_url('/') . "transaksirar_insert/deliveryorder/add"?>';
	...
	function details(id){
		...
		var loading ='<div align="center" class="loading"><img src="<?php echo base_url()?>front_assets/img/loading.gif"/></div>';
		uri = '<?php echo site_url('/') . "transaksirar_insert/deliveryorder/edit"?>';

                            ...
                            <tbody>
                                ...
                                foreach ($refjenisbarang as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td>  <a href="<?php echo base_url() ?>masterdata/masterjenisbarang/delete/<?php echo $row['idrefjenisbarang'] ?>" class="btn btn-danger" onclick="return confirm('Anda Yakin Ingin Menghapus Data Jenis Barang ini?')"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                    <?php $no++;
                                }
                                ?>        

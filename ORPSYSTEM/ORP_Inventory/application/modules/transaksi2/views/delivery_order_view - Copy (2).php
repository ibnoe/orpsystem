...
<div class="content">
                                                    ...
                                                    <td>
                                                        ...
                                                        <table id="pemesanan_barang" width="100%">
                                                            ...
                                                            <tr>
																...
																<td width="40px"><input  type="text" size="3" id="urutan_jenis_barang_1"  name="urutan_jenis_barang[]" value="1"></td>
																<td width="150px">
																	<select  id="idrefbarang"  name="idrefbarang[]"  class="form-control">
																...
																<td>
                                                                    <select  id="idpackaging"  name="idpackaging[]"  class="form-control">
																		<option value="0"> --- Pilih Packaging ---</option>
																		<?php
                                                    ...
                                                    <td>
                                                        ...
                                                        <table id="pemesanan_paket" width="100%">
                                                            ...
                                                            <tr>
																...
																<td width="40px">
																	<input  type="text" size="3" id="urutan_jenis_barang_1"  name="urutan_jenis_barang[]" value="1"/>
																</td>
																<td width="150px">
																	<select  id="idpackage"  name="idpackage[]"  class="form-control">;
    ...
    <script>
        ...
        function addItem() {
            GB_show("Delivery Order", '<?php echo base_url(); ?>transaksi/pengadaan/add', 700, 1180);
            $('html, body').animate({scrollTop: 0}, 'slow');
        }
        ...
        function messageOut(id) {
            ...
            function print() {
                GB_show("Pengadaan", '<?php echo base_url(); ?>transaksi/pengadaan/print', 700, 1180);
                $('html, body').animate({scrollTop: 0}, 'slow');
            }
        ...
        var url = '<?php echo base_url() ?>ajax/combobox/getJenisBarang';
        $.post(url,
                {
                    id: id,
                    idRefBarang: value

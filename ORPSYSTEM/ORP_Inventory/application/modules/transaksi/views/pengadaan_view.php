                                ...
                                foreach ($pengadaan as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo site_url('/transaksi/pengadaan/delete/'.$row['idpengadaan']) ?>" class="btn btn-danger" onclick="return confirm('Anda Yakin Ingin Menghapus Data Pengadaan ini?')"><i class="fa fa-trash"></i>Hapus</a> 

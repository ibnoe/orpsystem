...
<body>
    ...
    <div style="background-color: #ffffff">
        ...
        <div class="tabbable">
            ...
            <form role="form" action="<?php echo base_url() ?>transaksi/deliveryorder/add_proccess" id="form_entry" name="form_entry" class="form-horizontal" method="POST"  enctype="multipart/form-data">
...
<?php echo Modules::run('front_templates/front_templates/js_master'); ?>
            ...
            <script>
                                          ...
                                          function getUkuran(id, value) {
                                              ...
                                              var url = '<?php echo base_url() ?>ajax/combobox/getUkuranBarang';

                        ...
                        <div class="col-md-12">                 
                            <div class="form-group">
                                ...
                                <div class="col-sm-3 input-group">
                                    <input type="text" name="tangal_dari" id="tanggal_dari"  data-date-format="dd-mm-yyyy" value="<?php echo date('d-m-Y') ?>" data-date-viewmode="years" class="form-control  date-picker">  
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3 input-group">
                                    <input type="text" name="tangal_sampai" id="tanggal_sampai"  data-date-format="dd-mm-yyyy" value="<?php echo date('d-m-Y') ?>" data-date-viewmode="years" class="form-control date-picker">
                                    <span class="input-group-addon"> <i class="fa fa-calendar"></i> </span>
                                </div>
                            </div>   
                            <div class="form-group">
...
<script>
                                        ...
                                        function cetakPDF() {
                                            ...
                                            GB_show("Cetak Daftar Barang Masuk", '<?php echo base_url() ?>index.php/transaksi/pengadaan/cetakDaftar/' + tanggal_dari + '/' + tanggal_sampai, 500, 1080);
